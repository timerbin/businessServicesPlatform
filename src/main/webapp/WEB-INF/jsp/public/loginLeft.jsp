        ...
        <ul>
            ...
            <c:if test="${not empty services_user_info}">
            	<c:if test="${services_user_info.type == 2}">
		            <li id=""><span><img src="${BASE_URL}/images/gerenzx_x5.png" /></span><a href="${BASE_URL}/user/toAllCompany.html">企业管理</a></li>
		            <li id=""><span><img src="${BASE_URL}/images/gerenzx_x6.png" /></span><a href="${BASE_URL}/user/toServiceManage.html">服务管理</a></li>
