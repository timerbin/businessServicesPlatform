    ...
    <td  valign="top">
        ...
        <div class="form_box">
            ...
            <table width="900" border="0" cellspacing="20" cellpadding="0">
              ...
              <tr>
                <td align="right">&nbsp;</td>
                <td><input name="" type="button"  value="保 存" class="form_button bjse_hong">
                    <input name="" type="button"  value="提 交" class="form_button bjse_lan">
                    <input name="" type="reset"  value="重 置" class="form_button bjse_cheng">
                </td>
                <td>&nbsp;</td>
              </tr>
            </table>
